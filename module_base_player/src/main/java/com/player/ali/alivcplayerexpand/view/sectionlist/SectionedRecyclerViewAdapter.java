package com.player.ali.alivcplayerexpand.view.sectionlist;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} with the position of the {@link com.player.ali.alivcplayerexpand.view.sectionlist.Section.State}
     ...
     * the position of the {@link com.player.ali.alivcplayerexpand.view.sectionlist.Section.State} view holder in the adapter. Useful to be called after
    ...
    /**
     * Helper method that calls {@link #notifyItemRangeRemoved} and {@link #notifyItemChanged} with
     * the position of the {@link com。player.alivcplayerexpand.view.sectionlist.Section.State} view holder in the adapter. Useful to be called after
     * changing the State from LOADED to LOADING/ FAILED/ EMPTY.
     *
     * @param section                   a visible section of this adapter
     * @param previousContentItemsCount previous content items count of section
