package com.player.ali.svideo.common.base;
...
import com.player.ali.svideo.common.baseAdapter.BaseQuickAdapter;
import com.player.ali.svideo.common.baseAdapter.BaseViewHolder;
...
public class AlivcListSelectorDialogFragment extends BaseDialogFragment {
    ...
    protected void bindView(View view) {
        ...
        //自定义分割线
        DividerItemDecoration itemDecoration = new DividerItemDecoration(Objects.requireNonNull(getActivity()), OrientationHelper.VERTICAL);
        itemDecoration.setDrawable(Objects.requireNonNull(ContextCompat.getDrawable(getActivity(), R.drawable.alivc_common_rv_divider_gray_vertical)));
