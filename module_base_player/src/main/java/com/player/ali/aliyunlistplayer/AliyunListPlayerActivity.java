package com.player.ali.aliyunlistplayer;
...
import com.player.ali.JsonUtil;
import com.player.ali.aliyunlistplayer.view.AliyunListPlayerView;
...
//        });
        ...
        Gson gson = new Gson();
        AliyunVideoListBean aliyunVideoListBean = gson.fromJson(JsonUtil.json, AliyunVideoListBean.class);
        if (aliyunVideoListBean != null && aliyunVideoListBean.getCode() == ServiceCommon.RESPONSE_SUCCESS) {
            AliyunVideoListBean.VideoDataBean data = aliyunVideoListBean.getData();
            int total = data.getTotal();
            List<AliyunVideoListBean.VideoDataBean.VideoListBean> videoList = data.getVideoList();
