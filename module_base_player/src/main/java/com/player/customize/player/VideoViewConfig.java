package com.player.customize.player;


import androidx.annotation.Nullable;

import com.player.customize.AliPlayerFactory;
import com.player.customize.render.RenderViewFactory;
import com.player.customize.render.TextureRenderViewFactory;
...
public class VideoViewConfig {
    ...
    private VideoViewConfig(Builder builder) {
        ...
        if (builder.mPlayerFactory == null) {
            ...
            mPlayerFactory = AliPlayerFactory.Companion.create();
        } else {
