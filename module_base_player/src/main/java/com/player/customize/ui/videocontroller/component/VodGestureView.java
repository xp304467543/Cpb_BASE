...
import static com.player.customize.util.PlayerUtils.stringForTime;
 ...
 * @ Describe
 */
public class VodGestureView extends FrameLayout implements IGestureComponent {

    public VodGestureView(@NonNull Context context) {
        super(context);
    }

    public VodGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public VodGestureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
