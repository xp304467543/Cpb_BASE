 ...
 * @ Describe 视频播放器顶部
 */
public  class VodTitleView extends FrameLayout implements IControlComponent {
    ...
    public VodTitleView(@NonNull Context context) {
        super(context);
    }

    public VodTitleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public VodTitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.vod_title_view, this, true);
