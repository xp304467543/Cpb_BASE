...
class LiveRoomBetGuessFragment1 : BaseNormalFragment<Any?>() {
                    ...
                    "二中二" -> {
                        ...
                        if (!play_sec_data[position].isSelected) {
                            ...
                            if (moreSelect?.size!! > 2) {
                                ...
                                if (moreSelect?.size == 2) {
                                    val data = PlaySecData(play_class_cname = moreSelect!![0].play_class_cname + "," + moreSelect!![1].play_class_cname,play_sec_id =  play_sec_data[position].play_class_id,
                                       play_sec_name =  play_sec_data[position].play_sec_name,
                    ...
                    "三中三" -> {
                        ...
                        if (!play_sec_data.get(position).isSelected) {
                            ...
                            if (threeSelect?.size!! > 3) {
                                ...
                                adapter?.notifyDataSetChanged()
                                if (threeSelect?.size == 3) {
                                    val data = PlaySecData(threeSelect!![0].play_class_cname + "," + threeSelect!![1].play_class_cname + "," + threeSelect!![2].play_class_cname, play_sec_id =play_sec_data[position].play_class_id,play_sec_name =  play_sec_data[position].play_sec_name,
