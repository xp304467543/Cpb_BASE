...
public class TabControlView extends RadioGroup implements HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs) throws Exception {
        ...
        try {
            ...
            mRadius = attributes.getDimensionPixelSize(R.styleable.TabControlView_tcv_item_radius, -1);
    ...
    private void update() {
        ...
        while (itemIterator.hasNext()) {
            ...
            if (i == 0) {
                //Left
                updateRadioButton(rb, R.drawable.tcv_left_option, R.drawable.tcv_left_option_selected, false);
            } else if (i == (mItemMap.size() - 1)) {
                //Right
                updateRadioButton(rb, R.drawable.tcv_right_option, R.drawable.tcv_right_option_selected, false);
            } else {
                //Middle
                updateRadioButton(rb, R.drawable.tcv_middle_option, R.drawable.tcv_middle_option_selected, true);
            }
     ...
     */
    private void updateRadioButton(RadioButton rb, int tcv_option_normal, int tcv_option_selected, Boolean isMiddle) {
