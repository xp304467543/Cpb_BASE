...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener, HasTypeface {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            //设置color
            btnSubmit.setTextColor(ViewUtils.INSTANCE.getColor(R.color.colorBluePrimary));
            btnCancel.setTextColor(ViewUtils.INSTANCE.getColor(R.color.colorBluePrimary));
