package com.lib.basiclib.widget.tab.buildins.commonnavigator.indicators;
...
import com.lib.basiclib.widget.tab.FragmentContainerHelper;
import com.lib.basiclib.widget.tab.buildins.ArgbEvaluatorHolder;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init() {
        ...
        mMaxCircleRadius = ViewUtils.INSTANCE.dp2px(3.5F);
        mMinCircleRadius = ViewUtils.INSTANCE.dp2px(2);
        mYOffset = ViewUtils.INSTANCE.dp2px(1.5F);
    }
