package com.lib.basiclib.widget.tab.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = ViewUtils.INSTANCE.dp2px( 3);
        mCircleSpacing = ViewUtils.INSTANCE.dp2px(  8);
        mStrokeWidth = ViewUtils.INSTANCE.dp2px(  1);
    }
