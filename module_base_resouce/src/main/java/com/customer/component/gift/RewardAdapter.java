package com.customer.component.gift;
...
import com.customer.component.gift.anim.AnimUtils;
import com.customer.component.gift.anim.NumAnim;
...
public class RewardAdapter implements RewardLayout.GiftAdapter<SendGiftBean> {
    ...
    public View onInit(View view, SendGiftBean bean) {
        ImageView giftImage = view.findViewById(R.id.iv_gift_img);
        ImageView giftUserPhoto = view.findViewById(R.id.riv_gift_my_avatar);
        ...
        GlideUtil.INSTANCE.loadImage(mContext,bean.getGiftImg(), giftImage);
        GlideUtil.INSTANCE.loadCircleImage(mContext,bean.getUserPhoto(), giftUserPhoto,true);
    ...
    public View onUpdate(View view, SendGiftBean o, SendGiftBean sendGiftBean) {
        ...
        GlideUtil.INSTANCE.loadImage(mContext,o.getGiftImg(), giftImage);
        // 数字刷新动画
