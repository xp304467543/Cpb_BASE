...
import com.lib.basiclib.base.xui.utils.DensityUtils.sp2px
...
class MarqueeTextView : View {
    ...
    private fun init(context: Context) {
        ...
        mPaint!!.textSize = sp2px(12F).toFloat()
    }
    ...
    fun setTextSize(textSize: Float) {
        ...
        mPaint!!.textSize = if (mTextSize <= 0) sp2px(12f).toFloat() else mTextSize
        requestLayout()
        invalidate()
    }
