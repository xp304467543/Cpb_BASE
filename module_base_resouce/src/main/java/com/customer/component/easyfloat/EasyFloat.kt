...
import com.customer.component.easyfloat.core.FloatingWindowManager
...
import com.customer.component.easyfloat.interfaces.*
...
class EasyFloat {
    ...
    companion object {
        ...
        @JvmStatic
        @JvmOverloads
        fun updateFloatView(tag: String? = null) =
            FloatingWindowManager.getHelper(tag)?.updateFloatView()
    ...
    class Builder(private val activity: Context) : OnPermissionResult {
         ...
         */
        @JvmOverloads
        fun setGravityOffset( offsetX: Int = 0, offsetY: Int = 0) = apply {
            config.offsetPair = Pair(offsetX, offsetY)
        }
