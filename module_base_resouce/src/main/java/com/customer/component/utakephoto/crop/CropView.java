...
package com.customer.component.utakephoto.crop;
...
public class CropView extends View {
    ...
    private void setup(Context context) {
        ...
        mShadow = (NinePatchDrawable) ContextCompat.getDrawable(context,R.drawable.geometry_shadow);
        mCropIndicator =  ContextCompat.getDrawable(context,R.drawable.camera_crop);
