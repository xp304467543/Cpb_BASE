package com.customer.component.utakephoto.utils;
...
public class ImgUtil {
    ...
    public static int getMetadataRotation(Context context, Uri uri) {
        try {
            ...
            Timber.d(String.valueOf(System.currentTimeMillis() - l));
            return orientation;
    ...
    private static int getMetadataOrientation(Context context, Uri uri) {
        ...
        try {
            ...
            Timber.tag(TAG).w(e, "Failed to read EXIF orientation");
        } finally {
            try {
                if (is != null) {
                    is.close();
                ...
                Timber.tag(TAG).w(e, "Failed to close InputStream");
            }
        }
        return ORIENTATION_NORMAL;
    }
